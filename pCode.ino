...
// Servo range
#define _DUTY_MIN 800     //서보의 가동 최소 각도
#define _DUTY_NEU 1400        //servo neutral position (90 degree)
#define _DUTY_MAX 1900                // 서보의 최대 가동 각도
#define _POS_START (_DUTY_MIN + 100)


// Servo speed control
#define _SERVO_ANGLE 30   // 서보의 각도(30º) 
#define _SERVO_SPEED 50             //  서보 속도를 30으로 설정
// float _SERVO_SPEED = 30;
//_SERVO_SPEED 30
...
const float coE[] = {-0.0000006, -0.0005827, 1.2521237, -20.5099941};
float x;
...
////////////////////
  ...
  // P control logic
    dt = time_end - time_curr;
    error_curr = _DIST_TARGET - dist_raw; // [3158] 목표값 에서 현재값을 뺀 값이 오차값
    pterm = _KP*error_curr;
//    iterm += _KI*error_curr*dt;
//    dterm = _KD*(error_curr-error_prev)/dt;
